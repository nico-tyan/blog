...
public class CustomFileCacheQueueScheduler extends DuplicateRemovedScheduler implements MonitorableScheduler,Closeable {
    ...
    public CustomFileCacheQueueScheduler(String filePath) {
